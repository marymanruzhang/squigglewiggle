...
export const PROFILES = {
  ...
  sheep: {
    ...
    motionParams: { walkSpeed: 60, bounceHeight: 6, stepFreq: 2.0 },
  },
  rabbit: {
    category: 'ground_animal',
    defaultMotion: 'hop',
    tags: ['animal', 'mobile', 'ground_based', 'herbivore', 'prey', 'curious'],
    motionParams: { hopHeight: 22, hopSpeed: 0.7 },
  },
  dog: {
    category: 'ground_animal',
    defaultMotion: 'walk_bounce',
    tags: ['animal', 'mobile', 'ground_based', 'predator', 'pet', 'curious'],
    motionParams: { walkSpeed: 85, bounceHeight: 8, stepFreq: 2.4 },
  },
  cat: {
    category: 'ground_animal',
    defaultMotion: 'prowl',
  ...
  cow: {
    ...
    motionParams: { walkSpeed: 40, bounceHeight: 4, stepFreq: 1.5 },
  },
  horse: {
    category: 'ground_animal',
    defaultMotion: 'walk_bounce',
    tags: ['animal', 'mobile', 'ground_based', 'herbivore'],
    motionParams: { walkSpeed: 100, bounceHeight: 10, stepFreq: 2.6 },
  },
  mouse: {
    category: 'ground_animal',
    defaultMotion: 'scurry',
    tags: ['animal', 'mobile', 'ground_based', 'prey'],
    motionParams: { walkSpeed: 130, bounceHeight: 3, stepFreq: 5.0 },
  },
  frog: {
    category: 'ground_animal',
    defaultMotion: 'hop',
    tags: ['animal', 'mobile', 'ground_based', 'prey', 'water_creature'],
    motionParams: { hopHeight: 28, hopSpeed: 0.55 },
  },
  kangaroo: {
    category: 'ground_animal',
    defaultMotion: 'hop',
    tags: ['animal', 'mobile', 'ground_based', 'herbivore'],
    motionParams: { hopHeight: 35, hopSpeed: 0.6 },
  },
  elephant: {
    category: 'ground_animal',
    defaultMotion: 'walk_bounce',
    tags: ['animal', 'mobile', 'ground_based', 'herbivore', 'obstacle'],
    motionParams: { walkSpeed: 35, bounceHeight: 5, stepFreq: 1.2, leanAmp: 3 },
  },
  bear: {
    category: 'ground_animal',
    defaultMotion: 'walk_bounce',
    tags: ['animal', 'mobile', 'ground_based', 'predator'],
    motionParams: { walkSpeed: 60, bounceHeight: 7, stepFreq: 1.8 },
  },
  lion: {
    category: 'ground_animal',
    defaultMotion: 'prowl',
  ...
  tiger: {
    ...
    defaultMotion: 'prowl',
    tags: ['animal', 'mobile', 'ground_based', 'predator'],
    motionParams: { walkSpeed: 75 },
  },
  giraffe: {
    category: 'ground_animal',
    defaultMotion: 'walk_bounce',
    tags: ['animal', 'mobile', 'ground_based', 'herbivore'],
    motionParams: { walkSpeed: 45, bounceHeight: 3, stepFreq: 1.4, leanAmp: 3 },
  },
  man: {
    category: 'human_character',
    defaultMotion: 'walk_bounce',
    tags: ['character', 'mobile', 'human'],
    motionParams: { walkSpeed: 65, bounceHeight: 7, stepFreq: 2.1 },
  },
  woman: {
    category: 'human_character',
    defaultMotion: 'walk_bounce',
  ...
  'stick figure': {
    ...
    defaultMotion: 'walk_bounce',
    tags: ['character', 'mobile', 'human'],
    motionParams: { walkSpeed: 70, bounceHeight: 8, stepFreq: 2.2 },
  },
